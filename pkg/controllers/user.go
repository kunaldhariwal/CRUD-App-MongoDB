...
func (uc UserController) CreateUser(c *gin.Context) {
	...
	u := uc.create_user(json.BlockId, json.BlockHash, json.Height, json.ActivityId, json.EventId, c)
	if u.Name == json.Name {
		content := gin.H{
			"result": "Success",
			"BlockId":   u.BlockId,
...
func (uc UserController) UpdateUser(c *gin.Context) {
	...
	u := uc.update_user(id, json.BlockId, json.BlockHash, json.Height, json.ActivityId, json.EventId, c)
...
func (uc UserController) create_user(BlockId string, BlockHash string, Height int, ActivityId int, EventId int, c *gin.Context) models.User {
	user := models.User{
		BlockId:   BlockId,
		BlockHash: BlockHash,
		Height:    Height,
...
func (uc UserController) update_user(BlockId string, BlockHash string, Height int, ActivityId int, EventId int, c *gin.Context) models.User {
